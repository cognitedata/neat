...
from thisisneat.core._data_model._constants import PATTERNS, get_reserved_words
from thisisneat.core._data_model._shared import (
    ImportContext,
    ImportedDataModel,
...
from thisisneat.core._data_model.models.data_types import (
    AnyURI,
    DataType,
    Enum,
    File,
...
from thisisneat.core._issues._factory import from_pydantic_errors
from thisisneat.core._issues.errors import CDFMissingClientError, NeatValueError
...
from thisisneat.core._utils.rdf_ import get_inheritance_path
from thisisneat.core._utils.text import (
...
class _ConceptualDataModelConverter:
    ...
    def _as_physical_property(
        ...
        from thisisneat.core._data_model.models.physical._verified import PhysicalProperty
