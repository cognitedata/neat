...
from thisisneat.core._data_model.models.conceptual import ConceptualProperty
...
from thisisneat.core._data_model.transformers import SubsetConceptualDataModel
...
class MockGraphGenerator(BaseExtractor):
    ...
    def __init__(
        ...
        if isinstance(data_model, PhysicalDataModel):
            ...
            from thisisneat.core._data_model.transformers import PhysicalToConceptual
