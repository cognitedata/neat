...
from thisisneat.core._issues.warnings import PropertyDataTypeConversionWarning
from thisisneat.core._utils.auxiliary import string_to_ideal_type
from thisisneat.core._utils.rdf_ import Triple, get_namespace, remove_namespace_from_uri, uri_to_cdf_id
