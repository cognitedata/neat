...
run-explorer:
	...
	poetry run uvicorn --host 0.0.0.0 cognite.neat._app.api.explorer:app
...
configure:
	...
	cd cognite/neat/_app/ui/neat-app; npm install
...
build-ui:
	...
	cd cognite/neat/_app/ui/neat-app; npm run build
...
start-ui-dev:
	...
	cd cognite/neat/_app/ui/neat-app; npm start
