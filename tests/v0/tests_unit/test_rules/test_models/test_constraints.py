...
from cognite.neat.legacy.core._data_model.models.entities import ContainerConstraintEntity, ContainerEntity
from cognite.neat.legacy.core._data_model.models.physical._unverified import _parse_constraints
