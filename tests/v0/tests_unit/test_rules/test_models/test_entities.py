...
from cognite.neat._v0.core._data_model._constants import ENTITY_PATTERN, PATTERNS
...
from cognite.neat._v0.core._data_model.models.entities._single_value import ContainerEntity
