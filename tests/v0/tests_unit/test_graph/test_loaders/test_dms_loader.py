...
from cognite.neat.legacy.core._data_model.importers import SubclassInferenceImporter
...
from cognite.neat.legacy.core._issues.warnings import PropertyDirectRelationLimitWarning
