...
from cognite.neat._v0.core._instances.extractors import RdfFileExtractor
from cognite.neat._v0.core._instances.transformers._value_type import SplitMultiValueProperty
