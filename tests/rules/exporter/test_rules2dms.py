...
def test_rules2dms(simple_rules):
    ...
    assert list(data_model.views) == ["CountryGroup", "Country", "PriceArea", "PriceAreaConnection"]
    assert list(data_model.containers) == ["CountryGroup", "Country", "PriceArea", "PriceAreaConnection"]
