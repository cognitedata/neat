...
from cognite.neat._graph.extractors import BaseExtractor, UnknownNamespaceExtractorMapper
from cognite.neat._shared import Triple


class TestUnknownNamespaceExtractorMapping:
    def test_extract(self) -> None:
        ...
        mapper = UnknownNamespaceExtractorMapper(
            extractor,
            {"イ覧誠んしは": "myProperty"},
            {"my$$$type": "MyType"},
        )
