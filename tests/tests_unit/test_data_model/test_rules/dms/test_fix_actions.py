...
class TestConstraintIdGeneration:
    ...
    def test_auto_constraint_id_within_limit(self) -> None:
        ...
        dst_ref = ContainerReference(space="test", external_id="ShortName")
        constraint_id = make_auto_constraint_id(dst_ref)
    ...
    def test_auto_constraint_id_truncates_long_names_with_hash(self) -> None:
        ...
        long_name = "A" * 50
        dst_ref = ContainerReference(space="test", external_id=long_name)
        constraint_id = make_auto_constraint_id(dst_ref)
    ...
    def test_auto_constraint_id_hash_ensures_uniqueness(self) -> None:
        ...
        prefix = "A" * 28
        dst1 = ContainerReference(space="test", external_id=prefix + "XXXXXXXXXXXXXXX")
        dst2 = ContainerReference(space="test", external_id=prefix + "YYYYYYYYYYYYYYY")

        constraint_id1 = make_auto_constraint_id(dst1)
        constraint_id2 = make_auto_constraint_id(dst2)
    ...
    def test_auto_constraint_id_exactly_at_limit_no_hash(self) -> None:
        ...
        dst_ref = ContainerReference(space="test", external_id=exact_name)
        constraint_id = make_auto_constraint_id(dst_ref)
    ...
    def test_auto_constraint_id_one_over_limit_uses_hash(self) -> None:
        ...
        dst_ref = ContainerReference(space="test", external_id=over_name)
        constraint_id = make_auto_constraint_id(dst_ref)
