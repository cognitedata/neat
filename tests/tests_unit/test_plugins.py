...
from cognite.neat._plugin._interfaces import PhysicalDataModelFileWriterPlugin, PhysicalDataModelReaderPlugin
...
class TestPluginManager:
    def test_plugin_loaded(self, manager: PluginManager) -> None:
        ...
        assert len(manager.get(PhysicalDataModelFileWriterPlugin)) == 1, "No PhysicalDataModelFileWriterPlugin found"
