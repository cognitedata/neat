...
EVENTS_EXTRACTOR_DATA = Path(__file__).parent / "events_extractor_data"
FILES_EXTRACTOR_DATA = Path(__file__).parent / "files_extractor_data"
LABELS_EXTRACTOR_DATA = Path(__file__).parent / "labels_extractor_data"
