...
class TestAssetRulesConverter:
    ...
    def test_to_space(self, prefix: str, expected_space: str) -> None:
        actual_space = _AssetRulesConverter._to_space(prefix)

        assert actual_space == expected_space

    def test_svein_harald_information_as_dms(self, svein_harald_information_rules: AssetRules) -> None:
        expected = {
    ...
    def test_convert_above_container_limit(self) -> None:
        info = AssetRulesInput(
            ...
            classes=[AssetClassInput(class_="MassiveClass")],
            properties=[
                AssetPropertyInput(
                    class_="MassiveClass",
