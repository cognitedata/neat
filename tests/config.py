...
SIMPLECIM_TRANSFORMATION_RULES = (
    PACKAGE_DIRECTORY / "legacy" / "rules" / "examples" / "Rules-Nordic44.xlsx"
)
SIMPLECIM_TRANSFORMATION_RULES_DMS_COMPLIANT = (
    ...
    / "rules"
    / "examples"
    / "Rules-Nordic44-to-graphql.xlsx"
)
SIMPLE_TRANSFORMATION_RULES = (
    ...
    / "rules"
    / "examples"
    / "sheet2cdf-transformation-rules.xlsx"
)
SIMPLE_TRANSFORMATION_RULES_DATES = (
    TEST_FOLDER / "data" / "sheet2cdf-transformation-rules-date.xlsx"
)
PARTIAL_MODEL_TEST_DATA = TEST_FOLDER / "data" / "partial-model"

# Example graph files
NORDIC44_KNOWLEDGE_GRAPH = (
    PACKAGE_DIRECTORY / "graph" / "examples" / "Knowledge-Graph-Nordic44.xml"
)
NORDIC44_KNOWLEDGE_GRAPH_DIRTY = (
    PACKAGE_DIRECTORY / "graph" / "examples" / "Knowledge-Graph-Nordic44-dirty.xml"
)
