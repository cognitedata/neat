...
class TestCreateAPI:
    ...
    def test_create_enterprise_maintain_reference_new_endpoint(
        ...
        result_path = tmp_path / "result.xlsx"
        neat.data_model.write.excel(result_path, include_reference=True, include_properties="same-space")
