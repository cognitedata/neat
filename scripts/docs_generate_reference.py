...
from cognite.neat.legacy.core._data_model.models import PhysicalDataModel, ConceptualDataModel
from cognite.neat.legacy.core._data_model.models._base_verified import BaseVerifiedDataModel
