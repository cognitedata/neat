...
from cognite.neat.app.api.configuration import NEAT_APP, UI_PATH, WORKFLOW_TEMPLATES_PATH
...
app.mount("/templates", StaticFiles(directory=WORKFLOW_TEMPLATES_PATH), name="templates")
