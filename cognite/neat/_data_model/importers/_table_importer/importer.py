...
from cognite.neat._data_model.models.dms import RequestSchema, DataModelRequest, ViewRequest, ContainerRequest, BtreeIndex, InvertedIndex
from cognite.neat._utils.useful_types import CellValue
from .data_class import TableDMS, Metadata, DMSProperty, DMSView, DMSContainer
from cognite.neat._data_model.models.entities import parse_entity
class DMSTableImporter(DMSImporter):
    ...
    def to_data_model(self) -> RequestSchema:
        try:
            ...
            raise NotImplementedError("Error handling is not yet implemented.")
    ...
    def _create_container_property(self, prop: DMSProperty) -> ContainerProperty:
        parsed = parse_entity(prop.index)
        parsed.suffix:{
            "properties": [prop.container_property]
            "indexType": parsed.suffix,
            **parsed.properties,
        }
