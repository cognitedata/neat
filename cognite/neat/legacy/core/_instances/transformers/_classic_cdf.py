...
from cognite.neat.legacy.core._constants import CLASSIC_CDF_NAMESPACE, DEFAULT_NAMESPACE
...
from cognite.neat.legacy.core._issues.warnings import ResourceNotFoundWarning
