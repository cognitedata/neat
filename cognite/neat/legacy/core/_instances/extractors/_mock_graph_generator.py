...
from cognite.neat.legacy.core._data_model.models.conceptual import ConceptualProperty
...
from cognite.neat.legacy.core._data_model.transformers import SubsetConceptualDataModel
