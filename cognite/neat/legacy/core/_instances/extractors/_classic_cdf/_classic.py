...
from cognite.neat.legacy.core._data_model.catalog import classic_model
from cognite.neat.legacy.core._data_model.models import (
    ConceptualDataModel,
    UnverifiedConceptualDataModel,
)
from cognite.neat.legacy.core._instances.extractors._base import KnowledgeGraphExtractor
from cognite.neat.legacy.core._issues.errors import NeatValueError, ResourceNotFoundError
from cognite.neat.legacy.core._issues.warnings import CDFAuthWarning, NeatValueWarning
from cognite.neat.legacy.core._shared import Triple
from cognite.neat.legacy.core._utils.collection_ import chunker, iterate_progress_bar
from cognite.neat.legacy.core._utils.rdf_ import remove_namespace_from_uri
from cognite.neat.legacy.core._utils.text import to_snake_case
...
class ClassicGraphExtractor(KnowledgeGraphExtractor):
    ...
    def get_conceptual_data_model(self) -> ConceptualDataModel:
        ...
        from cognite.neat.legacy.core._data_model.importers import ExcelImporter
