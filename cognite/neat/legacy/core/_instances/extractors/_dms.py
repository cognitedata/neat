...
from cognite.neat.legacy.core._constants import DEFAULT_SPACE_URI, is_readonly_property
from cognite.neat.legacy.core._issues.errors import ResourceRetrievalError
