...
from cognite.neat.legacy.core._constants import DEFAULT_BASE_URI
from cognite.neat.legacy.core._instances._shared import RDFTypes
from cognite.neat.legacy.core._instances.extractors._base import BaseExtractor
