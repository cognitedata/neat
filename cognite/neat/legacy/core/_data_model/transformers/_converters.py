...
from cognite.neat.legacy.core._data_model._constants import CONSTRAINT_ID_MAX_LENGTH, PATTERNS, get_reserved_words
...
from cognite.neat.legacy.core._data_model.models import (
    ConceptualDataModel,
    PhysicalDataModel,
    SheetList,
...
from cognite.neat.legacy.core._data_model.models.data_types import (
    AnyURI,
    DataType,
    Enum,
    File,
...
from cognite.neat.legacy.core._data_model.models.entities._single_value import ContainerConstraintEntity
...
from cognite.neat.legacy.core._data_model.models.physical._verified import (
    PhysicalContainer,
    PhysicalEnum,
    PhysicalNodeType,
)
from cognite.neat.legacy.core._issues import IssueList
from cognite.neat.legacy.core._issues._factory import from_pydantic_errors
from cognite.neat.legacy.core._issues.errors import CDFMissingClientError, NeatValueError
...
from cognite.neat.legacy.core._utils.rdf_ import get_inheritance_path
from cognite.neat.legacy.core._utils.text import (
...
class _ConceptualDataModelConverter:
    ...
    def _as_physical_property(
        ...
        from cognite.neat.legacy.core._data_model.models.physical._verified import PhysicalProperty
