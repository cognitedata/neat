...
from cognite.neat.legacy.core._data_model.importers._rdf._base import BaseRDFImporter
from cognite.neat.legacy.core._data_model.importers._rdf._shared import (
    parse_concepts,
    parse_properties,
)
