...
from cognite.neat.legacy.core._constants import get_default_prefixes_and_namespaces
...
from cognite.neat.legacy.core._issues.errors import PropertyDefinitionError
