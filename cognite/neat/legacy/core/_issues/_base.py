...
class NeatIssue:
    ...
    def _dump_value(cls, value: Any) -> list | int | bool | float | str | dict:
        from cognite.neat.legacy.core._data_model.models.entities import ConceptualEntity
    ...
    def load(cls, data: dict[str, Any]) -> "NeatIssue":
        ...
        from cognite.neat.legacy.core._issues.warnings import _NEAT_WARNINGS_BY_NAME
