...
from cognite.neat.core.graph import extractors
from cognite.neat.core.loaders.cdfcore.labels import upload_labels
from cognite.neat.graph.loaders import categorize_assets, rdf2assets, upload_assets
from cognite.neat.core.loaders.cdfcore.rdf_to_relationships import (
    categorize_relationships,
    rdf2relationships,
    upload_relationships,
)
from cognite.neat.core.graph.extractors import NeatGraphStore, drop_graph_store
from cognite.neat.core.rules.exporter.rules2triples import get_instances_as_triples
from cognite.neat.core.rules.models import TransformationRules
from cognite.neat.core.graph.transformations.transformer import RuleProcessingReport, domain2app_knowledge_graph
...
with contextlib.suppress(ValueError):
    prom_data_issues_stats = Gauge("neat_default_wf_data_issues", "Data validation issues", ["type"])


class DefaultNeatWorkflow(BaseWorkflow):
