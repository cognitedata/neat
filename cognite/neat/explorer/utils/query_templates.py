query_templates = [
    ...
    },
    {
        ...
        "query": """ SELECT ?tagValue ?tagPath (?parentName AS ?node_name)  (?parentClass AS ?node_class) ?parentPath (?parentInst AS ?node_id ) (?parentInst AS ?src_object_ref) (?parentInst2 AS ?dst_object_ref) WHERE { 
