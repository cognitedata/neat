...
ReadInputRules: TypeAlias = ReadRules[DMSInputRules] | ReadRules[ConceptualUnvalidatedDataModel]
T_ReadInputRules = TypeVar("T_ReadInputRules", bound=ReadInputRules)

Rules: TypeAlias = ConceptualDataModel | DMSRules | ReadRules[DMSInputRules] | ReadRules[ConceptualUnvalidatedDataModel]
