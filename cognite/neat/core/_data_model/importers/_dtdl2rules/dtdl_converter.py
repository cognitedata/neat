...
class _DTDLConverter:
    def __init__(self, issues: IssueList | None = None) -> None:
        ...
        self.properties: list[ConceptualUnvalidatedProperty] = []
        self.classes: list[ConceptualUnvalidatedConcept] = []
    ...
    def convert_interface(self, item: Interface, _: str | None) -> None:
        class_ = ConceptualUnvalidatedConcept(
    ...
    def convert_property(
        ...
        prop = ConceptualUnvalidatedProperty(
