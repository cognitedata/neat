...
from cognite.neat.core._client.data_classes.location_filters import (
    LocationFilter,
    LocationFilterList,
    LocationFilterWrite,
)
...
class LocationFiltersAPI(APIClient):
    def __init__(self, config: ClientConfig, api_version: str | None, cognite_client: CogniteClient) -> None:
        ...
        # this is hopefully a very temporary fix to avoid the client
        # concatenating the _RESOURCE_PATH with the ordinary /api/ path.
