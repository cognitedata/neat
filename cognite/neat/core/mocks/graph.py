...
from cognite.neat.core.transformer import COMMIT_BATCH_SIZE
...
def add_triples(graph_store: NeatGraphStore, triples: list[tuple], batch_size: int = COMMIT_BATCH_SIZE):
    ...
    batch_size : int, optional
        Batch size of triples per commit, by default COMMIT_BATCH_SIZE
    """
