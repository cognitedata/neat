...
from cognite.neat.core._utils.rdf_ import Triple, get_namespace, remove_namespace_from_uri, uri_instance_to_display_name
...
class ConnectionToLiteral(BaseTransformerStandardised):
    ...
    def operation(self, query_result_row: ResultRow) -> RowTransformationOutput:
        ...
        value = uri_instance_to_display_name(object_entity)
