...
class SpreadsheetError(NeatError, ValueError, ABC):
    ...
    @classmethod
    def create(cls, location: tuple[int | str, ...], error: NeatError, spreadsheet: SpreadsheetRead | None = None) -> 'SpreadsheetError':
        spreadsheet_name = location[0]
