...
INPUT_RULES_BY_ROLE: dict[
    RoleTypes,
    type[InformationInputRules] | type[DMSInputRules] | type[DomainInputRules],
] = {
    RoleTypes.domain_expert: DomainInputRules,
    RoleTypes.information: InformationInputRules,
    RoleTypes.dms: DMSInputRules,
}
VERIFIED_RULES_BY_ROLE: dict[RoleTypes, type[InformationRules] | type[DMSRules] | type[DomainRules]] = {
