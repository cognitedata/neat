...
class PhysicalDataModelWriterPlugin(NeatPlugin):
    ...
    def configure(self, **kwargs: Any) -> DMSExporter:
        """Return a configure plugin for data model export.
        Args:
            **kwargs (Any): Keyword arguments for plugin configuration.
                            The specific arguments depend on the plugin implementation.
        Returns:
            DMSExporter: An instance of typically subclassed DMSExporter, specialized for given plugin
        """

        raise NotImplementedError()


class PhysicalDataModelFileWriterPlugin(PhysicalDataModelWriterPlugin):
    """This class is used an interface for data model export to file plugins.
    Any plugin that is used for exporting data models to file should inherit from this class.
    It is expected to implement the `configure` method which returns a configured exporter
    with file export capabilities.
    ...
    def configure(self, **kwargs: Any) -> DMSFileExporter:
        """Return a configure plugin for data model export to file.
        Args:
            **kwargs (Any): Keyword arguments for plugin configuration.
                            The specific arguments depend on the plugin implementation.
        Returns:
            DMSFileExporter: An instance of typically subclassed DMSFileExporter, specialized for given plugin
        """
