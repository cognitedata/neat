...
from cognite.neat._data_model.rules.dms import DmsDataModelFixer, DmsDataModelValidation
...
class ReadPhysicalDataModel:
    ...
    def _create_on_success(self, fix: bool) -> DmsDataModelValidation | DmsDataModelFixer:
...
def create(
    ...
    on_success: DmsDataModelValidation | DmsDataModelFixer
    if fix:
